...
namespace SistemaVendas.Models
{
    public class ProdutoModel
    {
        ...
        public List<ProdutoModel> ListarTodosProdutos()
        {
            ...
            ProdutoModel item;
            DAL objDAL = new DAL();
            string sql = "SELECT id, nome, descricao, preco_unitario, quantidade_estoque, unidade_medida, link_foto FROM Produto order by nome";
        ...
        public ProdutoModel RetornarProduto(int? id)
        {
            ProdutoModel item;
            DAL objDAL = new DAL();
            string sql = $"SELECT id, nome, descricao, preco_unitario, quantidade_estoque, unidade_medida, link_foto FROM Produto where id ='{id}' order by nome";
            DataTable dt = objDAL.RetDataTable(sql);
